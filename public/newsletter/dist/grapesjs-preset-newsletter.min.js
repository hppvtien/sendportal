...
!(function (t, e) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports["grapesjs-preset-newsletter"] = e(require("grapesjs")))
        : (t["grapesjs-preset-newsletter"] = e(t.grapesjs));
    ...
    return (function (t) {
            ...
            (function (n) {
                ...
                (e = t.exports =
                    ...
                    (e.evaluate = function (t, e) {
                        return "string" == typeof t || n.isBuffer(t)
                            ? i.parseDOM(t, e)
                            : t;
                    }),
        ...
        function (t, e, r) {
            ...
            (function (e, n, i) {
                ...
                function l(t) {
                    if (
                        ((O = O || r(2)),
                        !(R.call(l, this) || this instanceof O))
                    )
                        return new l(t);
                    ...
                    (l.prototype.write = function (t, e, r) {
                        ...
                        return (
                            ...
                            n.ended
                                ? f(this, r)
                                : (o || h(this, n, t, r)) &&
                                  (n.pendingcb++, (i = d(this, n, o, t, e, r))),
                            i
                        );
                    }),
        ...
        function (t, e, r) {
            ...
            function i(t) {
                var e = n(t);
                if ("string" != typeof e && (y.isEncoding === m || !m(t)))
                        ...
                        (r = t[i]),
                            ...
                            !r && f[i]
                                ...
                                : (n +=
                                      i +
                                      '="' +
                                      (e.decodeEntities ? l.encodeXML(r) : r) +
                                      '"');
                    return n;
                }
            }
        ...
        function (t, e, r) {
            (function (e) {
                ...
                function p(t) {
                    return (
                        !(!q(t) || O(t)) && (D(t) || l(t) ? Tt : dt).test(C(t))
                    );
                }
                function d(t, e, r, n) {
                    for (
                ...
                function b(t, e, r) {
                    function n() {
                        return (
                            this && this !== _t && this instanceof n ? o : t
                ...
                function m(t, e, n) {
                    function i() {
                        ...
                        return (a -= l.length) < n
                            ...
                            : r(
                                  this && this !== _t && this instanceof i
                                      ? o
                                      : t,
                                  this,
                                  s
                ...
                function _(t, e, r, n, i, o, a, s, c, l) {
                    function h() {
                        for (
                            var k = arguments.length, E = Array(k), A = k;
                            A--;
                ...
                function L(t, e) {
                    for (
                        var r = t.length, n = Ct(e.length, r), i = v(t);
                        n--;
            ...
            (e.load = function (t, n) {
                ...
                (e.xml = function (t) {
                    return n(
                        this,
                        t,
                        s.defaults({ xmlMode: !0 }, this._options)
                    );
                }),
                (e.text = function (t) {
                    t || (t = this.root());
        ...
        function (t, e, r) {
            ...
            t.exports = {
                compile: function (t, e, r, n) {
                    var i = e.name,
                        o = e.data;
                    if (r && r.strict && !S.test(i))
                        throw SyntaxError(":" + i + " isn't part of CSS3");
                    if ("function" == typeof w[i])
                        return a(w[i], i, o), w[i](t, o, r, n);
                ...
                (e.parseCSS = function (t) {
                    for (
                        var e = n.parse(t, { position: !0, comments: !0 }),
                            r =
                                void 0 !== e.stylesheet && e.stylesheet.rules
                                    ? e.stylesheet.rules
                                    : [],
                            i = [],
                            o = 0,
                ...
                (e.getPreservedText = function (t, e) {
                    for (
                        var r = n.parse(t, { position: !0, comments: !0 }),
                            i =
                                void 0 !== r.stylesheet && r.stylesheet.rules
                                    ? r.stylesheet.rules
                                    : [],
                            o = [],
                            a = i.length - 1;
                        ...
                        ((e.fontFaces && "font-face" === i[a].type) ||
                            (e.mediaQueries && "media" === i[a].type)) &&
                            o.unshift(
                                n.stringify(
                                    { stylesheet: { rules: [i[a]] } },
        ...
        function (t, e, r) {
            ...
            (function (e, n) {
                ...
                function y(t, e) {
                    e.readingMore ||
                        ((e.readingMore = !0), B.nextTick(m, t, e));
                }
                function m(t, e) {
                    for (
                        var r = e.length;
                ...
                function x(t, e) {
                    e.resumeScheduled ||
                        ((e.resumeScheduled = !0), B.nextTick(S, t, e));
                }
                function S(t, e) {
                ...
                (u.prototype.read = function (t) {
                    ...
                    if (
                        ...
                        return (
                            ...
                            0 === e.length && e.ended ? O(this) : v(this),
                            null
                        );
                    ...
                    (u.prototype.pipe = function (t, e) {
                        ...
                        (p.pipesCount += 1),
                            F("pipe count=%d opts=%j", p.pipesCount, e);
                        var d =
                                (!e || !1 !== e.end) &&
                                t !== n.stdout &&
                                t !== n.stderr,
                            g = d ? i : f;
                        p.endEmitted ? B.nextTick(g) : h.once("end", g),
                            t.on("unpipe", r);
                        var v = _(h);
                        t.on("drain", v);
                        var b = !1,
        ...
        function (t, e) {
            ...
            function o(t, e, r) {
                var n = t[e];
                (T.call(t, e) && p(n, r) && (void 0 !== r || e in t)) ||
                    (t[e] = r);
            }
            function a(t) {
                if (!m(t)) return h(t);
        ...
        function (t, e) {
            ...
            function a(t, e, r) {
                var n = t[e];
                (O.call(t, e) && d(n, r) && (void 0 !== r || e in t)) ||
                    (t[e] = r);
            }
            function s(t) {
                if (!_(t)) return p(t);
                var e = h(t),
                    r = [];
                for (var n in t)
                    ("constructor" != n || (!e && O.call(t, n))) && r.push(n);
                return r;
            }
            function u(t, e) {
                return (
        ...
        function (t, e, r) {
            ...
            function n(t) {
                return function (e, r, n) {
                    return (
                        "function" != typeof e && (e = d(e, n, r)),
                        (r = Array.isArray(r) ? f(r) : l(r)),
                        t(e, r)
                    );
                };
            }
                        ...
                        return e.ignoreCase
                            ? ((n = n.toLowerCase()),
                              function (e) {
                                  ...
                                  return (
                                      null != a &&
                                      (a.length === i || "-" === a.charAt(i)) &&
                                      a.substr(0, i).toLowerCase() === n &&
                                      t(e)
                                  );
                              })
                            : function (e) {
            ...
            function n(t) {
                ...
                function l(e) {
                    if (1 == (e || 1)) "\n" == t[b] ? (m++, (v = 1)) : v++, b++;
                        ...
                        r.length > 1 && ((m += r.length - 1), (v = 1)),
                            (v += r[r.length - 1].length),
                            (b += e);
                    }
                }
                function f() {
                    (x.end = { line: m, col: v }),
                        i && a("addToken:", JSON.stringify(x, null, 2)),
                        S.push(x),
                        (g = ""),
                        (x = {});
                }
                            ...
                            switch (e()) {
                                ...
                                case "value":
                                    if (r("*")) {
                                        ...
                                        "before-value" == e() && c("value"),
                                            (g += d);
                                    break;
                                default:
                                    r("*")
                                        ? (h("comment"), u("comment"), l())
                                        : (g += d);
                            }
                            break;
                        case "*":
        ...
        function (t, e, r) {
            ...
            e.default = i.default.plugins.add(
                ...
                function (t, e) {
                    var n = e || {},
                        ...
                        a = {
                            ...
                            swichtVwBtnTitle:
                                n.swichtVwBtnTitle || "View Components",
                            ...
                            assetsModalTitle:
                                n.assetsModalTitle || "Select image",
                            styleManagerSectors: [
                                {
                                    name: "Dimension",
                                    open: !1,
                    ...
                    r(48)(n),
                        ...
                        !t.getHtml() &&
                            n.defaultTemplate &&
                            (t.setComponents(n.defaultTemplate),
                            t.editor.initChildrenComp(
                                t.DomComponents.getWrapper()
                            )),
                        t.on("change:selectedComponent", function () {
                            var e = t.Panels.getButton("views", "open-layers");
                            if (
                                (!e || !e.get("active")) &&
                                t.editor.get("selectedComponent")
                            ) {
                        ...
                        t.on("load", function () {
                            t.Panels.getButton(
                                "options",
                                "export-template"
                            ).set("attributes", { title: a.expTplBtnTitle }),
                                t.Panels.getButton("options", "fullscreen").set(
                                    "attributes",
                                ...
                                t.Panels.getButton("views", "open-sm").set(
                                    "attributes",
                                    { title: a.openSmBtnTitle }
                                ),
                                t.Panels.getButton("views", "open-tm").set(
                                    "attributes",
                                    { title: a.openTmBtnTitle }
                                ),
                                t.Panels.getButton("views", "open-layers").set(
                                    "attributes",
                    ...
                    var t = function t(e, r) {
                        e.each(function (e) {
                            if ("image" === e.get("type")) {
                                ...
                                r
                                    ? "##" === n &&
                                      e.set("src", e.get("src_bkp"))
                                    : "##" !== n &&
                                      (e.set("src_bkp", e.get("src")),
                                      e.set("src", "##"));
                            }
                ...
                (n = function () {
                    return function () {
                        var t =
                            ...
                            r =
                                e &&
                                e.CodeManager.getViewer("CodeMirror").clone(),
                        ...
                        return (
                            ...
                            (n.onclick = function () {
                                ...
                                e.DomComponents.getWrapper().set("content", ""),
                                    e.setComponents(t),
                                    e.Modal.close();
                            }),
                            r.set({
                ...
                (n = function () {
                    ...
                    return function () {
                        var e =
                            ...
                            n =
                                r &&
                                r.CodeManager.getViewer("CodeMirror").clone(),
                            i = document.createElement("div"),
                            o = e.pfx || "",
                            a = r.Commands,
                            s = e.juiceOpts || {};
                            ...
                            }),
                            {
                                run: function (r, a) {
                                    ...
                                    var h =
                                        ...
                                        r.getCss() +
                                        "</style>";
                                    n.setContent(e.inlineCss ? t(h, s) : h),
                                        u.open(),
                                        c.refresh(),
                                        a && a.set && a.set("active", 0);
                                },
                            }
                        );
                    };
        ...
        function (t, e, r) {
            ...
            (o.inlineContent = function (t, e, r) {
                return n(t, { xmlMode: r && r.xmlMode }, o.inlineDocument, [
                    e,
                    r,
                ]);
            }),
            ...
            function a(t) {
                ...
                return (
                    2 === a &&
                        ((e =
                            (f[t.charCodeAt(l)] << 2) |
                            (f[t.charCodeAt(l + 1)] >> 4)),
                        (s[u++] = 255 & e)),
                    1 === a &&
                        ((e =
                            (f[t.charCodeAt(l)] << 10) |
                            (f[t.charCodeAt(l + 1)] << 4) |
                            (f[t.charCodeAt(l + 2)] >> 2)),
                        (s[u++] = (e >> 8) & 255),
                        (s[u++] = 255 & e)),
                    s
                );
        ...
        function (t, e, r) {
            (function (t) {
                ...
                (e.setTimeout = function () {
                    return new n(
                        o.call(setTimeout, i, arguments),
                        clearTimeout
                    );
                }),
                    (e.setInterval = function () {
                        return new n(
                            o.call(setInterval, i, arguments),
                            clearInterval
                        );
                    }),
        ...
        function (t, e, r) {
            ...
            var a = r(18),
                ...
                h = (function () {
                    ...
                    for (
                        var e = Object.keys(s).sort(i),
                            r = Object.keys(a).sort(i),
                            n = 0,
                            u = 0;
                        n < r.length;
                        n++
            ...
            function s(t, e) {
                for (var r = 0, n = e.length; r < n; r++)
                    if (
                        c(e[r]) &&
                        (t(e[r]) ||
                            (e[r].children.length > 0 && s(t, e[r].children)))
                    )
                        return !0;
                return !1;
            }
        ...
        function (t, e) {
            ...
            e.uniqueSort = function (t) {
                ...
                for (t = t.slice(); --o > -1; )
                    (e = t[o]),
                        (i = t.indexOf(e)) > -1 && i < o && t.splice(o, 1);
                return (
                    t.sort(function (t, e) {
                        var i = n(t, e);
        ...
        function (t, e, r) {
            ...
            var m = function (t, e, r) {
                    ...
                    "string" == typeof e && void 0 !== r
                        ? (t.data[e] = r)
                        : "object" == typeof e && f.extend(t.data, e);
                },
                _ = function (t, e) {
                    var r,
                        n,
                      ...
                      a(this, function (t, e) {
                          if (o(e))
                              if (i) e.attribs.class = "";
                                  ...
                                  for (
                                      var a, s, u = x(e.attribs.class), c = 0;
                                      c < n;
                                      c++
                                  )
                                      (a = u.indexOf(r[c])) >= 0 &&
        ...
        function (t, e, r) {
            ...
            function l(t, e, r, n) {
                var i =
                    n && "scope" === t[0].name && "descendant" === t[1].type;
            ...
            (t.exports = n),
                (t.exports.compileUnsafe = o),
                (t.exports.compileToken = u);
            var p = r(92),
                d = r(4),
                g = d.isTag,
                v = r(93),
            ...
            function s(t, e, r) {
                ...
                for (a(0); "" !== e; )
                    if (((y = e.charAt(0)), o(y))) (x = !0), a(1);
                        ...
                        (x &&
                            (w.length > 0 && w.push({ type: "descendant" }),
                            (x = !1)),
                        "*" === y)
                    )
                        ...
                        if (((e = e.substr(1)), !(l = e.match(f))))
                            throw new SyntaxError(
                                "Malformed attribute selector: " + e
                            );
                        (e = e.substr(l[0].length)),
                            (m = i(l[1])),
                            (r &&
                                ("lowerCaseAttributeNames" in r
                                    ? !r.lowerCaseAttributeNames
                                    : r.xmlMode)) ||
                                (m = m.toLowerCase()),
                            w.push({
                                type: "attribute",
        ...
        function (t, e, r) {
            (function (t, r) {
                ...
                function g(t) {
                    ...
                    return (
                        !(r < 0) &&
                        (r == e.length - 1 ? e.pop() : le.call(e, r, 1),
                        --this.size,
                        !0)
                    );
                }
                ...
                function D(t, e, r) {
                    var n = t[e];
                    (Zt.call(t, e) && ut(n, r) && (void 0 !== r || e in t)) ||
                        P(t, e, r);
                }
                function q(t, e) {
                ...
                function z(t, e, r, n, i, o, s) {
                    ...
                    h && (s.set(c, f), i(f, c, n, o, s), s.delete(c)),
                        B(t, r, f);
                }
                function V(t, e) {
                ...
                function nt(t) {
                    var e = t && t.constructor;
                    return (
                        t === (("function" == typeof e && e.prototype) || Jt)
                    );
                }
                function it(t) {
                    var e = [];
                ...
                function ht(t) {
                    return (
                        "number" == typeof t && t > -1 && t % 1 == 0 && t <= kt
                    );
                }
                function pt(t) {
                    var e = typeof t;
        ...
        function (t, e, r) {
            (function (t, r) {
                ...
                function g(t, e) {
                    return (
                        (this.__data__[t] = ze && void 0 === e ? It : e), this
                    );
                }
                function v(t) {
                    var e = -1,
                ...
                function y(t) {
                    ...
                    return (
                        !(r < 0) &&
                        (r == e.length - 1 ? e.pop() : Pe.call(e, r, 1), !0)
                    );
                }
                function m(t) {
                    var e = this.__data__,
                ...
                function $(t, e, r, n, i, o) {
                    var a = er(t),
                        ...
                        c = $t,
                        l = $t;
                    a || ((c = Ke(t)), (c = c == Vt ? Zt : c)),
                        u || ((l = Ke(e)), (l = l == Vt ? Zt : l));
                    var f = c == Zt && !s(t),
                        h = l == Zt && !s(e),
                        p = c == l;
                    if (p && !f)
                ...
                function J(t) {
                    ...
                    var e = [];
                    for (var r in Object(t))
                        Oe.call(t, r) && "constructor" != r && e.push(r);
                    return e;
                }
                function Q(t) {
                    var e = at(t);
                ...
                function dt(t) {
                    var e = t && t.constructor;
                    return (
                        t === (("function" == typeof e && e.prototype) || ke)
                    );
                }
                function gt(t) {
                    return t === t && !At(t);
                ...
                function Et(t) {
                    return (
                        "number" == typeof t && t > -1 && t % 1 == 0 && t <= zt
                    );
                }
                function At(t) {
                    var e = typeof t;
        ...
        function (t, e, r) {
            function n(t, r, n, i) {
                for (var o = []; r && o.length < i; )
                    (n && !e.filter.call([r], n, t).length) || o.push(r),
                        (r = r.parent);
                return o;
            }
            var i = r(42),
                ...
                (e.parents = function (t) {
                    ...
                    return (
                        this.get()
                            .reverse()
                            .forEach(function (r) {
                                n(this, r.parent, t, 1 / 0).forEach(function (
                                    t
                                ) {
        ...
        function (t, e, r) {
            (function (t, r) {
                ...
                function v(t, e) {
                    return (
                        (this.__data__[t] = Ve && void 0 === e ? Nt : e), this
                    );
                }
                function b(t) {
                    var e = -1,
                ...
                function m(t) {
                    ...
                    return (
                        !(r < 0) &&
                        (r == e.length - 1 ? e.pop() : Me.call(e, r, 1), !0)
                    );
                }
                function _(t) {
                    var e = this.__data__,
                ...
                function dt(t) {
                    var e = t && t.constructor;
                    return (
                        t === (("function" == typeof e && e.prototype) || Ee)
                    );
                }
                function gt(t) {
                    return t === t && !Tt(t);
                ...
                function At(t) {
                    return (
                        "number" == typeof t && t > -1 && t % 1 == 0 && t <= Vt
                    );
                }
                function Tt(t) {
                    var e = typeof t;
            ...
            var p = function (t) {
                    return function () {
                        ...
                        return u(this, function (n, o) {
                            ...
                            (s =
                                "function" == typeof e[0]
                                    ? e[0].call(o, n, i.html(o.children))
                                    : e),
                                ...
                                u &&
                                    ...
                                    "string" != typeof t ||
                                        ...
                                        (t = this.parents()
                                            ...
                                            .find(t)
                                            .clone()),
                                    (a = this._makeDomArray(t, i < r).slice(
                                        0,
                                        1
                                    )),
                                    (s = c.indexOf(n)),
                ...
                (e.html = function (t) {
                    if (void 0 === t)
                        return this[0] && this[0].children
                            ? i.html(this[0].children, this.options)
                            : null;
                    var e = this.options;
                    return (
                        u(this, function (r, n) {
        ...
        function (t, e, r) {
            (function (e) {
                ...
                function n(t, e) {
                    for (
                        var r = -1, n = t ? t.length : 0, i = Array(n);
                        ++r < n;
                ...
                (e.serializeArray = function () {
                    ...
                    return this.map(function () {
                        ...
                        return "form" === e.name
                            ...
                            : r
                                  .filter("input,select,textarea,keygen")
                                  .toArray();
                    })
                        .filter(
        ...
        function (t, e, r) {
            function n(t, e) {
                ...
                e || (e = {}),
                    ...
                    (S = !!e.position),
                    (x = 0),
                    (j = Array.isArray(t) ? t.slice() : _(t));
                var n,
                    i,
                    a = [];
                for (y && (r = Date.now()); (i = o()); )
                    (n = p(i)) && a.push(n);
                return (
                    y && m("ran in", Date.now() - r + "ms"),
                    { type: "stylesheet", stylesheet: { rules: a } }
                );
            }
            function i(t, e) {
                e || (e = {});
                for (
                    var r, n = ["type", "name", "value"], i = {}, o = 0;
                    o < n.length;
                    ++o
                )
                    (r = n[o]), t[r] && (i[r] = e[r] || t[r]);
                for (n = Object.keys(e), o = 0; o < n.length; ++o)
                    (r = n[o]), i[r] || (i[r] = e[r]);
                return (
                    S && (i.position = { start: t.start, end: t.end }),
                    b && m("astNode:", JSON.stringify(i, null, 2)),
                    i
                );
            }
            function o() {
        ...
        function (t, e, r) {
            ...
            function h(t) {
                ...
                _ &&
                    x(
                        "stringifyDeclaration: unexpected node:",
                        JSON.stringify(t)
                    );
            }
            function p(t) {
        ...
        function (t, e, r) {
            ...
            (t.exports = n),
                (n.prototype.parsed = function () {
                    return (
                        this.tokens || (this.tokens = i(this.text)), this.tokens
                    );
                }),
                (n.prototype.specificity = function () {
                    ...
                    return (
                        this.spec || (this.spec = t(this.text, this.parsed())),
                        this.spec
                    );
                });
        },
        ...
        function (t, e, r) {
            ...
            (n.prototype.compareFunc = function (t) {
                var e = [];
                e.push.apply(e, this.selector.specificity()),
                    e.push.apply(e, this.additionalPriority),
                    (e[0] += this.priority);
                var r = [];
                return (
            ...
            t.exports = function (t) {
                function e(e, o, s) {
                            ...
                            function r(e, r) {
                                for (var o = 0, a = e.length; o < a; o++)
                                    if ("property" == e[o].type) {
                                        ...
                                        var f = [
                                                e[o].position.start.line,
                                                e[o].position.start.col,
                                            ],
                                            h = new n.Property(
                                                u,
                                                c,
                    ...
                    function c(t) {
                        ...
                        Object.keys(t.styleProps).forEach(function (e) {
                            for (var n = t.styleProps[e]; void 0 !== n; )
                                r.push(n), (n = n.nextProp);
                        }),
                            r.sort(function (t, e) {
                    ...
                    function l(t) {
                        if (t.pseudoElementType && t.styleProps.content) {
                            ...
                            n.img
                                ? ((t.name = "img"), e(t).attr("src", n.img))
                                : e(t).text(n);
                            var i = t.pseudoElementParent;
                            "before" === t.pseudoElementType
                                ? e(i).prepend(t)
                                : e(i).append(t);
                        }
                    }
                            ...
                            if (t[n + "Elements"].indexOf(i) > -1)
                                for (var o in r.styleProps)
                                    if (r.styleProps[o].prop === n) {
                                        ...
                                        if (
                                            t.tableElements.indexOf(i) > -1 &&
                                            r.styleProps[o].value.match(/\%/)
                                        )
                                            return void e(r).attr(
                                                n,
                                                r.styleProps[o].value
                                            );
                                    }
                        }
                    }
                    function h(t) {
                        return 0 !== t.indexOf("url(")
                            ? t
                            : t.replace(/^url\((["'])?([^"']+)\1\)$/, "$2");
                    }
                    function p(r) {
                ...
                function u(t, e) {
                    ...
                    return (
                        s.each(function () {
                            if (
                                ((o = this), (r = o.childNodes), 1 === r.length)
                            ) {
                                if (
                                    ((i = r[0].data),
                                    e.applyStyleTags &&
                                        void 0 === t(o).attr("data-embed") &&
                                        a.push(i),
                                    e.removeStyleTags &&
                                        void 0 === t(o).attr("data-embed"))
                                ) {
                                    var s = n.getPreservedText(
                                        o.childNodes[0].nodeValue,
                                        {
                                            mediaQueries:
                                                e.preserveMediaQueries,
                                            fontFaces: e.preserveFontFaces,
                                        }
                                    );
                                    s
                                        ? (o.childNodes[0].nodeValue = s)
                                        : t(o).remove();
                                }
